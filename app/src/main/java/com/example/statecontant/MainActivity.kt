...
import com.example.statecontant.ui.theme.StateContantTheme
...
fun MyNavigations(modifier: Modifier = Modifier) {
    ...
    NavHost(navController, startDestination = "MainScreen"){
        ...
        composable("InformationScreen/{username}/{family}/{ID}", arguments = listOf(
...
fun InputText(modifier: Modifier = Modifier) {
    ...
    Column(Modifier
        ...
        verticalArrangement = Arrangement.Center) {
        TextField(value = input, onValueChange = {input=it}, label = {Text("text")}
        )
    }
}
